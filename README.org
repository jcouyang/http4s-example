...
[[https://github.com/jcouyang/http4s-example/workflows/Build%20and%20Test/badge.svg]]

#+HTML: <a class="github-button" href="https://github.com/jcouyang/http4s-example" data-icon="octicon-star" aria-label="Star jcouyang/http4s-example on GitHub">Source Code</a>
